...
public class PathwaysControllerTest extends BaseTest {
    ...
    public void getContainedEvents() throws Exception {
        ...
        mvcGetResultNotFound("/data/pathway/r-hsa-69620/containedEvents");
    }
    ...
    public void getContainedEventsWithAttribute() throws Exception {
        ...
        mvcGetResultNotFound("/data/pathway/r-hsa-6968/containedEvents/displayname");
    }
    ...
    public void getPathwaysWithDiagramForAllFormsOf() throws Exception {
        mvcGetResult("/data/pathways/low/diagram/entity/R-HSA-199420/allForms", "application/json;charset=UTF-8", "species", "9606");

        mvcGetResultNotFound("/data/pathways/low/diagram/entity/R-HSA-5672972", "species", "9606");
    }

    //##################### API Ignored but still available for internal purposes #####################//
    @Test
    public void getLowerLevelPathwaysForIdentifier() throws Exception {
        mvcGetResult("/data/pathways/low/diagram/identifier/PTEN/allForms", "application/json;charset=UTF-8", "species", "9606");
    }
    ...
    public void getCuratedTopLevelPathways() throws Exception {
        mvcGetResult("/data/pathways/top/9606/curated", "application/json;charset=UTF-8");
    }
}